        ...
        return (
            <Animated.View style={[styles.bottom,
            {
                ...
                <View style={{flexDirection: 'row'}}>
                    <View style={{flex: 4}}>
                        <Text style={{fontSize: 20, fontWeight: '700', paddingBottom: 8}}>{this.props.title}</Text>
                        <Text style={{fontSize: 16, fontWeight: '700', color: this.props.colordispo, paddingBottom: 10}}>{this.props.description}</Text>
                        <Text style={{fontSize: 16, fontWeight: '500', color: 'gray'}}>{this.props.due}</Text>
                    </View>
